...
export class SendEmailComponent implements OnInit {
  ...
  public SendEmail(data, status: any) {
    debugger
    ...
    debugger
    this.subs.add(
      this.registerService.SendEmail(this.participantStatusDto).subscribe((data) => {
  ...
  public openFile() {
    window.open("assets/PDF/PARTICIPANT MANAGEMENT - SEND INVITATION.pdf");
  }
