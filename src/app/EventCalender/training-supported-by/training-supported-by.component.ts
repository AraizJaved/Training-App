...
@Component({
  selector: 'app-training-supported-by',
  templateUrl: './training-supported-by.component.html',
  styleUrls: ['./training-supported-by.component.scss']
})
export class TrainingSupportedByComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.RegisterForm = this.formBuilder.group({
      ...
      SupportedBy: ["", Validators.required],
  ...
  onSubmit() {
    ...
    if (this.RegisterForm.invalid) {
      ...
      if (!this.RegisterForm.controls.SupportedBy.value) {
    ...
    if(this.Category === 'Trainig Category'){
      ...
      let obj = {
        Id: 0,
        SupportedBy: this.RegisterForm.controls.SupportedBy.value
      }
      this.subs.add(
        this.registerService.AddSupportedBy(obj)
          .subscribe(
            (data) => {
              debugger
              console.log("/////////////////////////////////////////////", data)
