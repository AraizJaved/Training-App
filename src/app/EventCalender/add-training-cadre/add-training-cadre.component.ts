...
import { MeetingVenueDTO } from 'src/app/EventCalender/MeetingVenueDTO';
...
@Component({
  selector: 'app-add-training-cadre',
  templateUrl: './add-training-cadre.component.html',
  styleUrls: ['./add-training-cadre.component.scss']
})
export class AddTrainingCadreComponent implements OnInit {
  ...
  debugger
    ...
    this.subs.add(
      this.registerService.AddCadre(obj) 
     .subscribe(
        (data) => {
