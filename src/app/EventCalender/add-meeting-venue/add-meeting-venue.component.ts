...
@Component({
  selector: 'app-add-meeting-venue',
  templateUrl: './add-meeting-venue.component.html',
  styleUrls: ['./add-meeting-venue.component.scss']
})
export class AddMeetingVenueComponent implements OnInit {
  ...
  debugger
    ...
    this.formData.append('venue', this.RegisterForm.controls.designation.value)
    ...
    this.subs.add(
      this.registerService.AddMeetingVenue(this.formData) 
     .subscribe(
        (data) => {
