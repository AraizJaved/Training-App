...
@Component({
  selector: 'app-add-meeting-organizer',
  templateUrl: './add-meeting-organizer.component.html',
  styleUrls: ['./add-meeting-organizer.component.scss']
})
export class AddMeetingOrganizerComponent implements OnInit {
  ...
  onSubmit() {
    ...
    if (this.RegisterForm.invalid) {
      ...
      if (!this.RegisterForm.controls.designation.value) {
    ...
    if(this.Category === 'Trainig Category'){
      ...
      let obj = {
        Id: 0,
        TraingCategoryName: this.RegisterForm.controls.designation.value
      }
      this.subs.add(
        this.registerService.AddTraingCategory(obj)
          .subscribe(
            (data) => {
              debugger
              console.log("/////////////////////////////////////////////", data)
      ...
      let obj = {
        Id: 0,
        TrainingTypeName: this.RegisterForm.controls.designation.value
      }
      this.subs.add(
        this.registerService.AddTariningType(obj)
          .subscribe(
            (data) => {
              debugger
              console.log("/////////////////////////////////////////////", data)
