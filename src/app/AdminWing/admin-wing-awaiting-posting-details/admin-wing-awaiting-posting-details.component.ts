...
@Component({
    selector: 'app-admin-wing-awaiting-posting-details',
    templateUrl: './admin-wing-awaiting-posting-details.component.html',
    styleUrls: ['./admin-wing-awaiting-posting-details.component.scss']
})
export class AdminWingAwaitingPostingDetailsComponent implements OnInit {
    public obj: { id: number } = {
        id: 0,
    }
