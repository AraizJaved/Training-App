...
export class UpdateContactComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.getDistricts(this.Division);
    this.getTehsils(this.District);
  ...
  getContact(id: any) {
    ...
    this.subs.add(
      ...
      this.registerService.getContactById(id).subscribe(
        (data) => {
  ...
  setupForm(){
         ...
         this.RegisterForm.get("name").setValue(this.task[0].name);
        
        //  this.RegisterForm.get("designation").setValue(this.task[0].designation);
        //  this.RegisterForm.get("department").setValue(this.task[0].department);
         this.RegisterForm.get("email").setValue(this.task[0].email);
         this.RegisterForm.get("mobileNo").setValue(this.task[0].mobileNo);
         this.RegisterForm.get("district").setValue(this.task[0].district);
         this.RegisterForm.get("division").setValue(this.task[0].division);
         this.RegisterForm.get("tehsil").setValue(this.task[0].tehsil);
         this.RegisterForm.get("company").setValue(this.task[0].companyId);
         this.RegisterForm.get("department").setValue(this.task[0].departmentId);
         this.RegisterForm.get("category").setValue(this.task[0].categoryId);
         this.RegisterForm.get("designation").setValue(this.task[0].designationId);

         this.getDepartment(this.task[0].companyId);
         this.getCategory(this.task[0].departmentId);
         this.getDesignation(this.task[0].categoryId);
  ...
  onSubmit() {
    ...
    this.subs.add(
      this.registerService.Updateontact(this.formData) 
     .subscribe(
        (data) => {
