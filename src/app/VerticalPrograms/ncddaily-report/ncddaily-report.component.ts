...
@Component({
  selector: 'app-ncddaily-report',
  templateUrl: './ncddaily-report.component.html',
  styleUrls: ['./ncddaily-report.component.scss']
})
export class NCDDailyReportComponent implements OnInit {

  private subs = new Subscription();
  ncdDailyReportList = [];
  public searchString: string;
  fileName = 'NCD-daily-clinic-report.xlsx';
    ...
    this.subs.add(
      this.verticalProgramsService.getNcdDailyReportList().subscribe(
        (data) => {
          ...
          debugger
          var a = data
          this.ncdDailyReportList = a.data.info.ncdClinic;
