...
@Component({
  selector: 'app-tb-procurement',
  templateUrl: './tb-procurement.component.html',
  styleUrls: ['./tb-procurement.component.scss']
})
export class TbProcurementComponent implements OnInit {
    ...
    this.subs.add(
      this.developmentService.getProcurementList().subscribe(
        (data) => {
          ...
          this.procurementList = this.procurementList.filter(x => x.userDetail == 'TB Control Program')
