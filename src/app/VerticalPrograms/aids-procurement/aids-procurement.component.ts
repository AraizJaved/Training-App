...
@Component({
  selector: 'app-aids-procurement',
  templateUrl: './aids-procurement.component.html',
  styleUrls: ['./aids-procurement.component.scss']
})
export class AidsProcurementComponent implements OnInit {
    ...
    this.subs.add(
      this.developmentService.getProcurementList().subscribe(
        (data) => {
          ...
          this.procurementList = this.procurementList.filter(x => x.userDetail == 'Punjab Aids Control Program')
