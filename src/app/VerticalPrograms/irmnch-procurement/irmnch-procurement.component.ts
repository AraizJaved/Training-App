...
@Component({
  selector: 'app-irmnch-procurement',
  templateUrl: './irmnch-procurement.component.html',
  styleUrls: ['./irmnch-procurement.component.scss']
})
export class IrmnchProcurementComponent implements OnInit {
    ...
    this.subs.add(
      this.developmentService.getProcurementList().subscribe(
        (data) => {
          ...
          this.procurementList = this.procurementList.filter(x => x.userDetail == 'IRMNCH & Nutrition Program')
