...
// Doughnut
export var doughnutChartLabels: string[] = ['Fixed Site Form', 'Team Monitoring Form', 'Supervisor Monitoring Form',
'SIA Transit Site Monitoring Checklist', 'House Hold Form','Catch up days HH Cluster'];

export var doughnutChartData: number[] = [50, 30, 80,20,90,70];

export var doughnutChartColors: any[] = [{ backgroundColor: ["#4466f2", "#1ea6ec", "#22af47", "#007bff", "#ff9f40", "#FF5370", "#4466f2", "#1ea6ec", "#22af47"]}];
...
const a: {name: string, value: number}[] = [
  {
    name: 'Lahore',
    value: 100,
  },
...
const hf = a.find(a => a.value === 200)
const b = a.map(s => s.name)
const values = a.map(s => s.value)
