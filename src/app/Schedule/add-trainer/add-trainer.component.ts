...
export class AddTrainerComponent implements OnInit {
  ...
  onItemSelect(item: any) {
    ...
    this.DesignationId = this.RegisterForm.controls.DesignationId.value;
  ...
  onSubmit() {
    ...
    if ((formValues.districtsData.value == ''
      ...
      || formValues.DesignationId.value == 0
    ...
    this.subs.add(
      this.registerService.AddTrainer(this.TraineeDto).subscribe((data) => {
        ...
        if (data === true) {
          ...
          if (this.EventObj.status == 'Replace') {
            this.Response.emit(this.EventObj);
          }
