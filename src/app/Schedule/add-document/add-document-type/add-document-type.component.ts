...
export class AddDocumentTypeComponent implements OnInit {
  ...
  onSubmit() {
    ...
    if (this.RegisterForm.invalid) {
      ...
      if (!this.RegisterForm.controls.DocumentType.value ) {
  ...
  debugger
    ...
    this.formData.append('DocumentType', this.RegisterForm.controls.DocumentType.value)
    ...
    this.subs.add(
      this.registerService.AddDocumentType(obj) 
     .subscribe(
        (data) => {
