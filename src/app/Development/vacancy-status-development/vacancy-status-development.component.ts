...
@Component({
  selector: 'app-vacancy-status-development',
  templateUrl: './vacancy-status-development.component.html',
  styleUrls: ['./vacancy-status-development.component.scss']
})
export class VacancyStatusDevelopmentComponent implements OnInit {
